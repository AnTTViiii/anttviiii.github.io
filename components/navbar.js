document.getElementById("navbar").innerHTML = `
    ...
    <i class="toggle-open fa-solid fa-bars fa-2x" style="color: #1b1b1b; position: fixed; right: 25px; top: 20px" onclick="openNavBar()"></i>
    <i class="toggle-close fa-solid fa-x fa-2x hidden" style="color: #ff97ae; position: fixed; right: 25px; top: 20px" onclick="closeNavBar()"></i>
    <div class="navigation dflex align-items-center justify-content-center text-gray sm-sz">
